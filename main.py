...
window.config(bg="#835134")  # background colour of the window
window.title("Lotto Machine")  # Title of the window
            ...
            if email == " ":
                ...
                if not validate_email(email):
                    ...
                    if len(id) != 13:  # if the id is not 13 digits show an error
                        ...
                        # letters of users name and first 6 numbers of their id
                        ...
                        if int(self.age(id)) >= 18:  # checking if the user is over 18 or not
                            ...
                            window.destroy()  # once users age is checked and is over 18 this window will close and the
